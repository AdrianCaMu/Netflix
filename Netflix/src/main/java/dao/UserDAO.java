...
public class UserDAO extends AbstractDAO{
	...
	public boolean login(String correo, String passwd) {
		final String QUERY = "SELECT correo, password, activado FROM usuarios "+
	 ...
	 * @param passwd contraseña hash del usuario
	 * @param codigo codigo de validacion de la cuenta (-1 si no se ha generado codigo)
	 */
	public void register(String correo, String passwd, int codigo) {
		final String INSERT = "INSERT INTO usuarios (correo,password,codigo)"
				+ " VALUES ('"+ correo + "','"+ passwd + "', " + codigo +");";
		try {
