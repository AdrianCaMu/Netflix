...
public class RegisterView {
	...
	private void configureListener() {
		...
		//enviar codigo de activacion al pulsar enter desde confirmPasswd
	...
	private int obtenerCodigo() {
		...
		do {
			try {
				codigo = Integer.parseInt(JOptionPane.showInputDialog(frmRegister, "Codigo de activacion", "Activacion de cuenta"));
				valido = true;
